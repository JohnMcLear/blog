---
title: "A modern forum for a modern web"
date: 2014-04-16
categories: 
  - "nfc-ring"
  - "nodejs"
...
[![Screenshot from 2014-04-16 17:56:11](images/Screenshot-from-2014-04-16-175611-550x321.png)](https://mclear.co.uk/wp-content/uploads/2014/04/Screenshot-from-2014-04-16-175611.png)

We recently migrated our [NFC Ring forum](http://forum.nfcring.com) over from ProPHPBB (Hosted PHPBB) to [NodeBB](http://nodebb.org/). Let's be clear, in this blog post I'm not comparing like for like. ProPHPBB is a free service, it is open source, built on PHP and it's been the cornerstone of forums on the web for years. NodeBB is the young kid on the block.
...
Migration wasn't completely smooth, this wasn't a huge surprise because we have all been crazy busy but what mattered is that pretty much any time I hit a problem I could jump onto IRC and Julian would sort it out within a few hours. I have no regrets about using ProPHPBB initially as it gave us a very quick start with forums. Ultimately though, I'm happy with our new home and it's onwards and upwards for the [NFC Ring Forum](https://forum.nfcring.com)!
