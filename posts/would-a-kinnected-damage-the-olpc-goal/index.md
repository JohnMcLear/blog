---
title: "Would a \"kinnected\" classroom damage the OLPC goal"
date: 2011-01-25
categories: 
  - "ict"
  - "kinect"
...
Story telling etc. can receive additional immersion with real time physical space feedback. That is where the Kinect comes into it's own [IMHO](http://en.wikipedia.org/wiki/List_of_acronyms_and_initialisms%3A_I "List of acronyms and initialisms: I").. Before any Apple fan girls start moaning that I'm jumping on the MS bandwagon I think you should remember that I'm talking about the Kinect like it is the only space aware tool available because IT IS. The depth perception market isn't an iPod style market where Apple out-market Sony even though there product is inferior. If there were other options I would be considering them.
...
Are classrooms too small?  Various [Educational Technology](http://en.wikipedia.org/wiki/Educational_technology "Educational technology") Leaders are currently experimenting with it's place in the classroom.  Consolarium up in Scotland powered by the mighty Derek Robertson are doing some fantastic things and I'm looking forward to their feedback.
