...
e-Safe education claim the managed service will be able to detect keywords on PrimaryPad, which is likely because they also claim it can detect keywords in [SecondLife](http://Secondlife.com "Second Life").  The keystroke detection is a given and I expect this will work fine with very little headache.

# Conclusion

As someone who has written [child protection](http://en.wikipedia.org/wiki/Child_protection "Child protection") email algorithms before I understand how this service works and we should be clear from the outset this service will not detect 100% of the threats facing a pupil/teacher when they use technology.  e-safe education's managed service does however make for a cosy and somewhat expensive [comfort blanket](http://en.wikipedia.org/wiki/Security_blanket "Security blanket") for schools looking to increase their pupil safeguarding.
