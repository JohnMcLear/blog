---
title: "Preventing DoS attacks on Really-real time web applications"
date: 2020-05-26
---
...
You can, will and should optimize your code, reviewing any blocking processes with the [node profiler](https://nodejs.org/en/docs/guides/simple-profiling/) and optimizing your operating system and running node process. This will get you gains but again, even 100% _gains_ wont be sufficient to stop even the most basic of attacks.
...
[Source](https://github.com/animir/node-rate-limiter-flexible/wiki/Overall-example#websocket-single-connection-prevent-flooding)
...
Alternatively, if you prefer the Token Bucket Algorithm the [flood-protection](https://github.com/yatki/flood-protection) module may be preferable but being mindful no IP address restrictions are in place.
